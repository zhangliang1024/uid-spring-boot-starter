 ...
 * <br>10位的数据机器位，可以部署在1024个节点，包括5位datacenterId和5位workerId<br>
 * <br>12位序列，毫秒内的计数，12位的计数顺序号支持每个节点每毫秒(同一机器，同一时间截)产生4096个ID序号<br>
 * <br>
...
public class SnowflakeIdWorker {    
    ...
    public synchronized long nextId() {
        ...
        if (lastTimestamp == timestamp) {
            // 相同毫秒内，序列号自增：通过位与运算保证计算的结果范围始终是 0-4095
